...
server.r.get('/index.html', async ({ res }) => res.send.file('test/e2e/assets/index.html'))
server.r.get('/toggle.html', async ({ res }) => res.send.file('test/e2e/assets/toggle.html'))
